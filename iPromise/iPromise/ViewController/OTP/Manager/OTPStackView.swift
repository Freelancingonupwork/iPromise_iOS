...
class OTPStackView: UIStackView {
    ...
    //Colors
    let inactiveFieldBorderColor = color.grayColor()! //UIColor(white: 1, alpha: 0.3)
    let textBackgroundColor = color.whiteColor()!// UIColor(white: 1, alpha: 0.5)
    let activeFieldBorderColor = color.primaryColor()!
    ...
    private final func setupTextField(_ textField: OTPTextField){
        ...
        textField.font = UIFont.customFont(font: .regular, size: 16)
        textField.textColor = color.blackColor()
