...
class ProfileManager : NSObject{
    //MARK: -  variable
    fileprivate unowned var controller: ProfileVC
    fileprivate unowned var model: ProfileModel
    
    //MARK: -  intializer
    init(controller:ProfileVC, model:ProfileModel) {
        self.controller = controller
        self.model = model
    }
}
//MARK: - table view delegate
extension ProfileManager : UITableViewDataSource, UITableViewDelegate{
